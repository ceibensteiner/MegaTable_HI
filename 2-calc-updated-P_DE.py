...
p='/Users/cosimaeibensteiner/Desktop/home/PhD/1-Project/MEERKAT/scripts/0-data_base/1-MegaTables_including_MeerKAT/'
#path where we store the new databases that will include new calculations of P_DE_new
path_out = '/Users/cosimaeibensteiner/Desktop/home/PhD/1-Project/MEERKAT/scripts/0-data_base/1b-incl_new_P_DE/'
...
for i in range(8):
    ...
    t.write(path_out+galaxy[i]+'_base+MeerKAT_hexagon_1p5kpc.ecsv', add_timestamp=True, delimiter=',', overwrite=True)
